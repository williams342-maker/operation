...
export const collections = {
  ...
  emailLoginTokens: db.collection<EmailLoginTokenDoc>("email_login_tokens"),
...
async function ensureIndexes() {
  ...
  await Promise.all([
    ...
    collections.emailLoginTokens.createIndex({ tokenHash: 1 }, { unique: true }),
    collections.emailLoginTokens.createIndex({ orgId: 1, userId: 1, createdAt: -1 }),
    collections.emailLoginTokens.createIndex({ expiresAt: 1 }, { expireAfterSeconds: 0 }),
