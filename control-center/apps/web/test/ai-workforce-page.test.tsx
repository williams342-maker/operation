...
test("AI Workforce page discloses inactive workers and no credit use", () => { assert.match(source, /Background workers are not active yet/); assert.match(source, /do not consume provider credits/); assert.doesNotMatch(source, /API_KEY|credential|baseUrl/); });
