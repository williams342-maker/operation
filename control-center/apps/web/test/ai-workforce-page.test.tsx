...
test("AI Workforce page renders sanitized run outcomes", () => { assert.match(source, /run\.resultSummary/); assert.match(source, /run\.failureCategory/); assert.match(source, /Run failed:/); });
