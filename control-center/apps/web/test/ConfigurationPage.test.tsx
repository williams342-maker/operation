...
test("configuration page declares controlled non-production deployment and does not render credentials", () => {
  ...
  assert.match(html, /Production deployment unavailable/);
  assert.match(html, /Controlled configuration deployment/i);
