...
for (const [state, label] of [["success", "Current"], ["stale", "Stale"], ["truncated", "Truncated"], ["partial", "Partial"], ["agent_incompatible", "Discovery unavailable"], ["agent_offline", "Agent offline"], ["loading", "Loading"], ["discovery_failed", "Discovery failed"], ["permission_denied", "Permission denied"], ["empty", "No applications detected"]] as const) {
