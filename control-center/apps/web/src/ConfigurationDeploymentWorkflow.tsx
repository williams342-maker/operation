...
export function ConfigurationDeploymentWorkflow({ environmentKind, protectedEnvironment, state = "draft", onPlan, planningDisabled = false, actionError }: { environmentKind?: string; protectedEnvironment?: boolean; state?: DeploymentWorkflowState; onPlan?: () => void; planningDisabled?: boolean; actionError?: string }) {
