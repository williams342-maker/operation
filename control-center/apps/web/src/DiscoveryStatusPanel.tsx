...
const labels: Record<DiscoveryUiState, string> = { loading: "Loading", success: "Current", empty: "No applications detected", stale: "Stale", truncated: "Truncated", partial: "Partial", permission_denied: "Permission denied", agent_incompatible: "Agent upgrade required", discovery_failed: "Discovery failed", agent_offline: "Agent offline" };
