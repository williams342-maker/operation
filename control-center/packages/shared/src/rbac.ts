...
const rolePermissions: Record<Role, Permission[]> = {
  ...
  Developer: ["projects:manage", "status:view", "ai:use", "tasks:view", "tasks:run", "configuration:view", "configuration:edit-public", "configuration:validate", "configuration:view-history", "marketing:view", "marketing:import", "marketing:export", "seo:view", "seo:scan"],
  Viewer: ["status:view", "ai:use", "tasks:view", "configuration:view", "marketing:view", "marketing:export", "seo:view"]
};
