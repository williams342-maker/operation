...
export type ProjectDeploymentHistoryItem = { id: string; projectId: string; server: { id: string; name?: string }; environment: string; requestedRevision: string; deployedRevision?: string; branch?: string; artifactDigest?: string; releaseId?: string; taskId: string; planDigest?: string; approvalExpiresAt?: string; actor?: { id: string }; approval?: { approverId: string; approvedAt: string }; cancellation?: { cancelledById: string; cancelledAt: string }; controlPlanePreflight?: { status: "passed" | "failed"; checks: Array<{ name: string; passed: boolean }>; checkedAt: string; checkedById?: string }; gitPreflight?: { taskId: string; status: "queued" | "running" | "passed" | "failed"; checks: Array<{ name: string; passed: boolean }>; headRevision?: string; branch?: string; dirty?: boolean; checkedAt?: string }; status: ProjectDeploymentState; startedAt?: string; completedAt?: string; validation: ProjectValidationResult; rollbackAvailable: boolean; evidenceConfidence: "verified" | "reported"; failureClassification?: string; createdAt: string };
