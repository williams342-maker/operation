...
export const fetchReturnCaseReasons = () => http.get("/returns-cases/reasons").then((r) => r.data);
export const fetchBuyerCaseEligibility = (sessionId) => http.get(`/buyer/orders/${sessionId}/case-eligibility`, { headers: buyerAuthHeaders() }).then((r) => r.data);
export const createBuyerReturnCase = (sessionId, payload) => http.post(`/buyer/orders/${sessionId}/cases`, payload, { headers: buyerAuthHeaders() }).then((r) => r.data);
export const fetchBuyerReturnCases = (params = {}) => http.get("/buyer/cases", { headers: buyerAuthHeaders(), params }).then((r) => r.data);
export const fetchBuyerReturnCase = (caseId) => http.get(`/buyer/cases/${caseId}`, { headers: buyerAuthHeaders() }).then((r) => r.data);
export const sendBuyerCaseMessage = (caseId, payload) => http.post(`/buyer/cases/${caseId}/messages`, payload, { headers: buyerAuthHeaders() }).then((r) => r.data);
export const addBuyerReturnTracking = (caseId, payload) => http.post(`/buyer/cases/${caseId}/return-tracking`, payload, { headers: buyerAuthHeaders() }).then((r) => r.data);
export const acceptCaseOffer = (caseId, offerId) => http.post(`/buyer/cases/${caseId}/offers/${offerId}/accept`, {}, { headers: buyerAuthHeaders() }).then((r) => r.data);
export const declineCaseOffer = (caseId, offerId) => http.post(`/buyer/cases/${caseId}/offers/${offerId}/decline`, {}, { headers: buyerAuthHeaders() }).then((r) => r.data);
export const escalateBuyerCase = (caseId) => http.post(`/buyer/cases/${caseId}/escalate`, {}, { headers: buyerAuthHeaders() }).then((r) => r.data);
export const uploadBuyerCaseAttachment = (caseId, file) => { const fd = new FormData(); fd.append("file", file); return http.post(`/buyer/cases/${caseId}/attachments`, fd, { headers: { ...buyerAuthHeaders(), "Content-Type": "multipart/form-data" } }).then((r) => r.data); };

export const fetchMakerReturnCases = (params = {}) => http.get("/maker/cases", { headers: authHeaders(), params }).then((r) => r.data);
export const fetchMakerReturnCase = (caseId) => http.get(`/maker/cases/${caseId}`, { headers: authHeaders() }).then((r) => r.data);
export const sendMakerCaseMessage = (caseId, payload) => http.post(`/maker/cases/${caseId}/messages`, payload, { headers: authHeaders() }).then((r) => r.data);
export const approveMakerCaseReturn = (caseId, payload) => http.post(`/maker/cases/${caseId}/approve-return`, payload, { headers: authHeaders() }).then((r) => r.data);
export const approveMakerCaseRefund = (caseId, payload) => http.post(`/maker/cases/${caseId}/approve-refund`, payload, { headers: authHeaders() }).then((r) => r.data);
export const createMakerPartialRefundOffer = (caseId, payload) => http.post(`/maker/cases/${caseId}/partial-refund-offers`, payload, { headers: authHeaders() }).then((r) => r.data);
export const approveMakerCaseReplacement = (caseId, payload) => http.post(`/maker/cases/${caseId}/approve-replacement`, payload, { headers: authHeaders() }).then((r) => r.data);
export const denyMakerCase = (caseId, payload) => http.post(`/maker/cases/${caseId}/deny`, payload, { headers: authHeaders() }).then((r) => r.data);
export const escalateMakerCase = (caseId) => http.post(`/maker/cases/${caseId}/escalate`, {}, { headers: authHeaders() }).then((r) => r.data);

export const fetchAdminReturnCases = (params = {}) => http.get("/admin/returns-cases", { headers: adminAuthHeaders(), params }).then((r) => r.data);
export const fetchAdminReturnCase = (caseId) => http.get(`/admin/returns-cases/${caseId}`, { headers: adminAuthHeaders() }).then((r) => r.data);
export const fetchAdminReturnCaseAnalytics = () => http.get("/admin/returns-cases/analytics", { headers: adminAuthHeaders() }).then((r) => r.data);
export const addAdminCaseNote = (caseId, payload) => http.post(`/admin/returns-cases/${caseId}/notes`, payload, { headers: adminAuthHeaders() }).then((r) => r.data);
export const updateAdminCaseDeadline = (caseId, payload) => http.post(`/admin/returns-cases/${caseId}/deadline`, payload, { headers: adminAuthHeaders() }).then((r) => r.data);
export const approveAdminCaseReturn = (caseId, payload) => http.post(`/admin/returns-cases/${caseId}/approve-return`, payload, { headers: adminAuthHeaders() }).then((r) => r.data);
export const executeAdminCaseRefund = (caseId, payload) => http.post(`/admin/returns-cases/${caseId}/execute-refund`, payload, { headers: adminAuthHeaders() }).then((r) => r.data);
export const approveAdminCaseReplacement = (caseId, payload) => http.post(`/admin/returns-cases/${caseId}/approve-replacement`, payload, { headers: adminAuthHeaders() }).then((r) => r.data);
export const denyAdminCase = (caseId, payload) => http.post(`/admin/returns-cases/${caseId}/deny`, payload, { headers: adminAuthHeaders() }).then((r) => r.data);
export const closeAdminCase = (caseId, payload) => http.post(`/admin/returns-cases/${caseId}/close`, payload, { headers: adminAuthHeaders() }).then((r) => r.data);
export const reopenAdminCase = (caseId, payload) => http.post(`/admin/returns-cases/${caseId}/reopen`, payload, { headers: adminAuthHeaders() }).then((r) => r.data);
export const linkAdminProviderDispute = (caseId, payload) => http.post(`/admin/returns-cases/${caseId}/link-provider-dispute`, payload, { headers: adminAuthHeaders() }).then((r) => r.data);
