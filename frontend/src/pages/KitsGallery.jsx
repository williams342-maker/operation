      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        ...
        <div className="mb-12 max-w-3xl">
          ...
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl leading-[0.95] mb-4" data-testid="kits-gallery-title">
            ...
            <span className="text-[#ff4500]">Free SVG + DXF.</span>
          </h1>
          <p className="font-mono text-sm text-[#a3a3a3] leading-relaxed mb-6 max-w-2xl">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <Link
              to="/studio"
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#ff4500] text-[#0a0a0a] hover:bg-[#ff6a2a] font-mono text-[11px] uppercase tracking-[0.22em] font-bold transition"
            ...
            <div className="relative flex-1 min-w-[200px] max-w-md">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 bg-[#0a0a0a] border border-[#262626] focus:border-[#00ffff] outline-none font-mono text-xs text-[#e5e5e5] placeholder:text-[#525252]"
        ...
        {kits === null ? (
          ...
          <div className="border border-[#262626] bg-[#0a0a0a] p-12 text-center" data-testid="kits-gallery-empty">
            <Package size={28} className="mx-auto mb-4 text-[#525252]" />
            ...
            <Link
              to="/studio"
              className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-[0.22em] text-[#00ffff] hover:text-[#ff4500]"
            >
              Open the Studio →
            </Link>
          </div>
...
function KitCard({ kit, index }) {
  ...
  return (
    <motion.div
      ...
      className="group border border-[#262626] hover:border-[#ff4500] transition bg-[#0a0a0a]"
    ...
    >
      <Link to={`/kits/${kit.slug}`} className="block">
        ...
        <div className="p-4 space-y-2">
          <div className="font-display text-lg leading-tight text-[#e5e5e5] group-hover:text-[#ff4500] transition line-clamp-1">
            {kit.title}
          </div>
          {kit.description && (
            <p className="font-mono text-[11px] text-[#a3a3a3] line-clamp-2 leading-relaxed">
              {kit.description}
            </p>
          )}
          <div className="flex items-center justify-between pt-1">
            ...
            <span className="font-mono text-[9px] uppercase tracking-[0.22em] text-[#00ffff] group-hover:text-[#ff4500]">
              Open →
            </span>
          </div>
        </div>
