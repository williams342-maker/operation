...
export const POLICIES = [
  // ---------------------- CORE POLICIES ----------------------
  {
    ...
    description:
      "The foundational contract between every User and Crafters Market. Governs eligibility, accounts, fees, prohibited uses, moderation, disclaimers, liability, disputes, and AI use.",
    ...
    keywords: ["terms", "tos", "agreement", "eligibility", "accounts", "liability", "arbitration", "governing law", "washington", "moderation", "termination", "indemnify", "taxes", "marketplace facilitator", "ai", "artificial intelligence", "creator-owned ai", "ai training", "opt in", "operational ai"],
    attorney_notes: [
      ...
      { section: "Section 6a — AI Use (Creator-Owned AI Policy)", note: "NEW — confirm the split between Operational AI (allowed under content license) and AI Model Training (opt-in only) is enforceable, and that the no-penalty-for-declining clause meets consumer-protection expectations. Coordinate with Maker Agreement §10a and Privacy Policy §11." },
