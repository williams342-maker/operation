...
export const POLICIES = [
  // ---------------------- CORE POLICIES ----------------------
  {
    ...
    revision_history: [
      { version: "2.6", date: "2026-06-30", summary: "Final Legal Consistency Audit (v4): §5 broadens payout-hold disclosure — 'Certain payout holds may be imposed directly by Stripe, payment networks, financial institutions, or regulatory authorities'; §12 opt-out language references the internal ledger while retaining email as the authoritative legal submission method. Cross-document policy hierarchy audit: Maker Agreement elevated above Marketplace Policies for seller-specific issues." },
      ...
      { version: "2.3", date: "2026-06-30", summary: "Legal-hardening pass: added §14a Electronic Signatures & Acceptance (E-SIGN / UETA). Effective date is now maintained centrally and updated at deployment rather than hardcoded per policy." },
...

  {
    ...
    revision_history: [
      { version: "3.4", date: "2026-06-30", summary: "Final Legal Consistency Audit (v4): §2 Policy Hierarchy updated to align with the canonical policy hierarchy — Maker Agreement (seller-specific issues only) now sits between Terms of Service and Marketplace Policies." },
