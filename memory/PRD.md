...
- NEXT (per roadmap): P3 Cart-recovery drill-down · P3 Trending auto-boost nudge · Community Phase 2 (badges/collections/leaderboards) · returns & dispute center · ~~PolicyPage.jsx refactor~~ (done iter462c) · BLOCKED: Google Ads conversion labels (waiting on user).
